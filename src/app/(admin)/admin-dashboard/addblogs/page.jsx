...
export default function AddBlogs() {
  ...
  return (
    <>
      ...
      <div className="container col-xxl-8 px-2 py-5 mx-4">
        <div className="row flex-lg align-items-center g-5 py-5">
          <div className="col-10 col-sm-8 col-lg-6">
            <form>
              <div className="mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label fw-bold">Image Upload</label>
                <input type="file" className="form-control border border-black" id="exampleInputEmail1" aria-describedby="emailHelp" />
              </div>
              <div className="mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label fw-bold">Blog Title</label>
                <input type="text" className="form-control border border-black" id="exampleInputEmail1" aria-describedby="emailHelp" />
              </div>
              <div className="mb-3">
                <label htmlFor="exampleInputPassword1" className="form-label fw-bold">Blog Description</label>
                <textarea className="form-control border border-black" id="exampleInputPassword1" rows="3" />
              </div>
              <div className="mb-3">
                <label htmlFor="exampleInputPassword1" className="form-label fw-bold">Blog Category</label>
                <select id="disabledSelect" className="form-control border border-black">
